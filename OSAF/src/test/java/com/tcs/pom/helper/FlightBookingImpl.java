...
public class FlightBookingImpl extends BaseTest implements FlightBookingPage {
    ...
    public boolean newtourslogin(LinkedHashMap<String, String> dataSet, WebDriver driver,ExtentTest test) {
        ...
        try {
        	...
        	BaseTest.reportFailure(driver, test, "Verify Logging Successful", "Login is not Successful");
            e.printStackTrace();
        }
...
public boolean PHPTravelRegister(LinkedHashMap<String, String> dataSet, WebDriver driver,ExtentTest test) {
    ...
    try {
        ...
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(Firstname, BasePage.BY_TYPE.BY_ID, getDriver());
        String Firstname = dataSet.get("Firstname");
        BasePage.type(locator, Firstname, getDriver());
        BaseTest.reportPass(driver, test, "First name should be entered", "Firstname is entered");
        Thread.sleep(2000);
        
        test.log(LogStatus.INFO, "Entering Last name");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(Lastname, BasePage.BY_TYPE.BY_ID, getDriver());
        String Lastname = dataSet.get("Lastname");
        BasePage.type(locator, Lastname, getDriver());
        BaseTest.reportPass(driver, test, "Last name should be entered", "Lastname is entered");
        Thread.sleep(2000);
        
        test.log(LogStatus.INFO, "Entering Email address");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(Email, BasePage.BY_TYPE.BY_ID, getDriver());
        String Email = dataSet.get("Email");
        BasePage.type(locator, Email, getDriver());
        
        
        test.log(LogStatus.INFO, "Entering Phone number");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(Phone, BasePage.BY_TYPE.BY_ID, getDriver());
        String Phone = dataSet.get("Phone");
        BasePage.type(locator, Phone, getDriver());
        
        test.log(LogStatus.INFO, "Entering Street address");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(StreetAdress, BasePage.BY_TYPE.BY_ID, getDriver());
        String StreetAdress = dataSet.get("StreetAdress");
        BasePage.type(locator, StreetAdress, getDriver());
        
        test.log(LogStatus.INFO, "Entering City");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(City, BasePage.BY_TYPE.BY_ID, getDriver());
        String City = dataSet.get("City");
        BasePage.type(locator, City, getDriver());
        
        test.log(LogStatus.INFO, "Entering State");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(State, BasePage.BY_TYPE.BY_ID, getDriver());
        String State = dataSet.get("State");
        BasePage.type(locator, State, getDriver());
        
        test.log(LogStatus.INFO, "Entering Pincode");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(Pincode, BasePage.BY_TYPE.BY_ID, getDriver());
        String Pincode = dataSet.get("Pincode");
        BasePage.type(locator, Pincode, getDriver());
        
        test.log(LogStatus.INFO, "Entering Passowrd");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(PHPPassword, BasePage.BY_TYPE.BY_ID, getDriver());
        String PHPPassword = dataSet.get("PHPPassword");
        BasePage.type(locator, PHPPassword, getDriver());
        
        test.log(LogStatus.INFO, "Entering Confirm Passowrd");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(PHPCnfmPassword, BasePage.BY_TYPE.BY_ID, getDriver());
        String PHPCnfmPassword = dataSet.get("PHPCnfmPassword");
        BasePage.type(locator, PHPCnfmPassword, getDriver());
        
        BaseTest.reportPass(driver, test, "Registration details should be entered", "Registration details are entered");

        /*test.log(LogStatus.INFO, "Verifying Captcha");
        //System.err.println("Inside Login error message");
        locator = BasePage.getLocator(Captcha, BasePage.BY_TYPE.BY_XPATH, getDriver());        
        BasePage.click(locator, getDriver());*/
