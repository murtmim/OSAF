...
public class PHPTravlesFlightBooking extends FlightBookingImpl{
    ...
    public PHPTravlesFlightBooking()
    {
    ...
    public PHPTravlesFlightBooking(String testName, String browser, LinkedHashMap<String, String> mapDataSheet)
    {
    ...
    public Object[] testCreator(LinkedHashMap<String, String> mapDataSheet) {
        return new Object[] { new PHPTravlesFlightBooking(this.getClass().getSimpleName(),mapDataSheet.get("Browser"), mapDataSheet) };
    }
    ...
    public void beforemethod() throws MalformedURLException{
        ...
        report = new ExtentReports(reportpath+ "PHPFlightbookingTest.html",false);
    ...
    public void FlightbookingTest() throws Exception{
			...
			try {
				...
				PHPTravelRegister(mapDataSheet, getDriver(), test);				
				Thread.sleep(1000);
